...
flight_df = pd.read_csv("MLStreamlitApp/Data/flights-1m.csv")
motor_df = pd.read_csv("MLStreamlitApp/Data/mtcars.csv")
weather_df = pd.read_csv("MLStreamlitApp/Data/weather.csv")
